...
<head>
    ...
    <link rel="stylesheet" href="/resources/includes/db.php">
    <link rel="stylesheet" href="mysql_dat.sql">
    <style>
/* --------------------------------------------------------------------------- */
/* -------------------------------------Repeat------------------------------- */
/* ------------------------------------------------------------------------- */
...
<body>
    <header>   
        <div class="header">
            ...
            <a href="resources\data\Admin\FormLogin.php"><i class="far fa-user-circle col-1"></i></a>
            <a href="resources\data\Admin\FormSignUp.php"><i class="fas fa-user-plus col-1"></i></a>
            <a href="#"><i class="fas fa-shopping-bag col-1"></i></a>
            <a href="resources\data\Admin\FormSupport.php"><i class="far fa-question-circle col-1"></i></a>
        </div>
        ...
        <div class="topnav">
            ...
            <a href="resources\data\Catagory\CatagoryAcc.php" class="col-2">ACCESSORIES</a>
            <a href="resources\data\FormLoginAdmin.php" class="col-2">ADMIN AREA</a>
        </div>
        <div class="clearfix"></div>
    </header>
    <section>
        <div class="adv col-2 col-s-3">
        <img src="resources/img/ShopSecondHand.jpg" alt="HinhAnh" width="250px" height= "250px">
        </div>
        <div class="items col-8 col-s-9">
            <?php
            ...
            while($row_pro = mysqli_fetch_array($run_pro)){
                ...
                echo"
                <div class='single_product col-3'>
               <h3>$productName</h3>
                <img src='$product_Images' alt='hinhanh' width='200px' height= '200px' />
               <p><b>Price : $productPrice VND</b></p>
               <a href='resources/data/Detail/Detail.php'> Detallis</a>
               <a href=''>
        ...
        <div class="selection col-2 col-s-12">
            <?php
            $spl = " select * from categori";
            $run_pro = mysqli_query($connect,$spl);
            while($row_pro = mysqli_fetch_array($run_pro)){
                $CategoriName = $row_pro ['CategoriName'];
                echo"
                <div class='single_product'>
                <table>
                <tr>
                <td><input type='checkbox'></td>
                <td><h3>$CategoriName</h3></td>
                </tr>
                </table>
           </div>
                ";
