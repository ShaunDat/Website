...
<header>
    ...
    <section>
        ...
        <div class="items col-8 col-s-9">
            <?php
            $spl = " select * from product WHERE `CategoriID` = 3 ";
            ...
            $spl = " select * from product WHERE `CategoriID` = 4 ";
            $run_pro = mysqli_query($connect,$spl);
            while($row_pro = mysqli_fetch_array($run_pro)){
                $productID = $row_pro ['ProductID'];
                $productName = $row_pro ['ProductName'];
            ...
            $spl = " select * from product WHERE `CategoriID` = 6 ";
            $run_pro = mysqli_query($connect,$spl);
            while($row_pro = mysqli_fetch_array($run_pro)){
                $productID = $row_pro ['ProductID'];
                $productName = $row_pro ['ProductName'];
            ...
            $spl = " select * from product WHERE `CategoriID` = 7 ";
            $run_pro = mysqli_query($connect,$spl);
            while($row_pro = mysqli_fetch_array($run_pro)){
                $productID = $row_pro ['ProductID'];
                $productName = $row_pro ['ProductName'];
