    ...
    <img src="../../img/ShopSecondHand.jpg" alt="HinhAnh" width="250px" height= "250px">
        ...
        <div class=" col-10 col-s-9">
            ...
            while($row_pro = mysqli_fetch_array($run_pro)){
                ...
                <table class='CategoriView'>
                <tr>
                <td><input type='checkbox'></td>
                <td><h3>$CategoriID :</h3></td>
                <td><h3>$CategoriName</h3></td>
                <td><a href='CatagoryEdit.php'><button style= 'float :right'> Edit</button></a></td>
                <td><a href='CatagoryEdit.php'><button style= 'float :right'> Delete</button></a></td>
                </tr>
                </table>
           </div>
