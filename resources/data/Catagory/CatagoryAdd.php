    ...
    <section>
        ...
        <div class="form_main col-10 col-s-9">  
            ...
            <form method= "post" enctype="multipart/form-data"> 
                <tr>
                    <td><label>CatagoryName </label></td>
                </tr>
                <tr>
                    <td><input type="text" required placeholder="CatagoryName" name="CatagoryName"></td>
                </tr>
                <tr>
            ...
            $sql="Insert into categori values ('$CatagoryID','$CatagoryName')";
