        ...
        <div class="form_main col-10 col-s-12">
            <form method= "post"> 
                <table class="col-10 col-s-12">
                    <tr>
                    <td><p style="font-size: 35px"> Sign in to Show Second Hand</p></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    <td>
                    <a href="FormResetPass.php">Forgot password?</a></td>
                    </tr>
                    <td><input type="submit" value="Login" name="Login"></td>
                    <tr>
                        <td><label>Do not have an account? <a href ="FormSignUp.php">Create an account.</a></label></td>	
                    </tr>					  
                </table>
            </form>
