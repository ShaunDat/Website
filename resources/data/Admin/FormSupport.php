...
<body>
    <header>
        ...
        <div class="header">
            ...
            <input class="col-2 col-s-3 .col-s-s-1" type="search" name="" id="search" placeholder="SEARCH">
    ...
    <section>
        ...
        <h1>Website made by Vi Manh Dat for any questions, please contact:</h1>
        <p> Contact by phone number:096425400 <br>
            or by email:datvmbhaf190170@fpt.edu.vn <br>
            or by Facebook:www.facebook.com/Vimanhdat <br>
        </p>
        </div>
        <div class="clearfix"></div>
    </section>
